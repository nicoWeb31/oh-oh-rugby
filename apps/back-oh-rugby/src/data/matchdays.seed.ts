...
function matches(matchdayId: string, date: string, pairs: [string, string][]) {
...
export const MOCK_MATCHDAYS: Matchday[] = [
  {
    ...
    label: 'J1',
    date: '2026-09-05',
    matches: matches('md1', '2026-09-05', [
      ['Bayonne', 'Toulon'],
  ...
  },
  {
    ...
    label: 'J2',
    date: '2026-09-12',
    matches: matches('md2', '2026-09-12', [
      ['Perpignan', 'Castres'],
      ['Vannes', 'Montpellier'],
  ...
  },
  {
    ...
    label: 'J3',
    date: '2026-09-19',
    matches: matches('md3', '2026-09-19', [
      ['Bayonne', 'Clermont'],
  ...
  },
  {
    ...
    label: 'J4',
    date: '2026-09-26',
    matches: matches('md4', '2026-09-26', [
  ...
  },
  {
    ...
    label: 'J5',
    date: '2026-10-03',
    matches: matches('md5', '2026-10-03', [
  ...
  },
  {
    ...
    label: 'J6',
    date: '2026-10-10',
    matches: matches('md6', '2026-10-10', [
      ['Perpignan', 'Vannes'],
  ...
  },
  {
    ...
    label: 'J7',
    date: '2026-10-24',
    matches: matches('md7', '2026-10-24', [
      ['Bayonne', 'Lyon'],
      ['Vannes', 'Clermont'],
  ...
  },
  {
    ...
    label: 'J8',
    date: '2026-10-31',
    matches: matches('md8', '2026-10-31', [
      ['Perpignan', 'Toulon'],
  ...
  },
  {
    ...
    label: 'J9',
    date: '2026-11-07',
    matches: matches('md9', '2026-11-07', [
      ['Vannes', 'Bordeaux-Bègles'],
      ['Castres', 'Racing 92'],
      ['La Rochelle', 'Bayonne'],
      ['Montpellier', 'Lyon'],
      ['Pau', 'Perpignan'],
  ...
  },
  {
    ...
    label: 'J10',
    date: '2026-11-28',
    matches: matches('md10', '2026-11-28', [
      ['Bayonne', 'Castres'],
      ['Bordeaux-Bègles', 'Montpellier'],
      ['Clermont', 'Toulon'],
      ['La Rochelle', 'Perpignan'],
      ['Lyon', 'Toulouse'],
      ['Stade Français', 'Vannes'],
      ['Racing 92', 'Pau'],
    ]),
  },
  {
    ...
    label: 'J11',
    date: '2026-12-05',
    matches: matches('md11', '2026-12-05', [
      ['Perpignan', 'Clermont'],
      ['Vannes', 'Bayonne'],
      ['Castres', 'Lyon'],
  ...
  },
  {
    ...
    label: 'J12',
    date: '2026-12-19',
    matches: matches('md12', '2026-12-19', [
      ['Bayonne', 'Perpignan'],
      ['Bordeaux-Bègles', 'Pau'],
  ...
  },
  {
    ...
    label: 'J13',
    date: '2026-12-26',
    matches: matches('md13', '2026-12-26', [
      ['Perpignan', 'Lyon'],
      ['Vannes', 'La Rochelle'],
  ...
  },
  {
    ...
    label: 'J14',
    date: '2027-01-02',
    matches: matches('md14', '2027-01-02', [
      ['Bayonne', 'Toulouse'],
  ...
  },
  {
    ...
    label: 'J15',
    date: '2027-01-23',
    matches: matches('md15', '2027-01-23', [
      ['Vannes', 'Perpignan'],
      ['Castres', 'Clermont'],
  ...
  },
  {
    ...
    label: 'J16',
    date: '2027-01-30',
    matches: matches('md16', '2027-01-30', [
  ...
  },
  {
    ...
    label: 'J17',
    date: '2027-02-20',
    matches: matches('md17', '2027-02-20', [
      ['Bayonne', 'La Rochelle'],
      ['Perpignan', 'Pau'],
      ['Vannes', 'Castres'],
  ...
  },
  {
    ...
    label: 'J18',
    date: '2027-02-27',
    matches: matches('md18', '2027-02-27', [
  ...
  },
  {
    ...
    label: 'J19',
    date: '2027-03-20',
    matches: matches('md19', '2027-03-20', [
  ...
  },
  {
    ...
    label: 'J20',
    date: '2027-03-27',
    matches: matches('md20', '2027-03-27', [
      ['Bayonne', 'Montpellier'],
  ...
  },
  {
    ...
    label: 'J21',
    date: '2027-04-17',
    matches: matches('md21', '2027-04-17', [
      ['Castres', 'Bayonne'],
      ['La Rochelle', 'Vannes'],
      ['Lyon', 'Perpignan'],
  ...
  },
  {
    ...
    label: 'J22',
    date: '2027-04-24',
    matches: matches('md22', '2027-04-24', [
      ['Bayonne', 'Pau'],
  ...
  },
  {
    ...
    label: 'J23',
    date: '2027-05-08',
    matches: matches('md23', '2027-05-08', [
      ['Bayonne', 'Vannes'],
      ['Clermont', 'Perpignan'],
      ['Lyon', 'Stade Français'],
  ...
  },
  {
    ...
    label: 'J24',
    date: '2027-05-15',
    matches: matches('md24', '2027-05-15', [
      ['Perpignan', 'Bayonne'],
  ...
  },
  {
    ...
    label: 'J25',
    date: '2027-05-29',
    matches: matches('md25', '2027-05-29', [
      ['Bayonne', 'Racing 92'],
      ['Castres', 'Pau'],
  ...
  },
  {
    ...
    label: 'J26',
    date: '2027-06-05',
    matches: matches('md26', '2027-06-05', [
      ['Perpignan', 'Toulouse'],
