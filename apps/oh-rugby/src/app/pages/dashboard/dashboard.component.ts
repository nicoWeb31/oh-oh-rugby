    ...
    <div class="dashboard">
      ...
      <section class="matchdays-grid">
        @for (md of allMatchdays(); track md.id) {
          <a
            [routerLink]="['/matchday', md.id]"
            class="md-card"
            [class]="statusClass(md.id)"
          >
      ...
      <div class="quick-ranking">
        ...
        <a routerLink="/ranking" class="btn-secondary"
...
export class DashboardComponent {
  ...
  globalRanking = computed(() => this.rankingService.getGlobal());
